                        ...
                        <ul id="dropdown-lp" class="py-2 space-y-2 text-sm">
                            ...
                            <li>
                                ...
                                <ul id="dropdown-tr" class="py-2 space-y-2 text-sm">
                                    ...
                                    <li>
                                        <a href="tr_oneway.php" class="flex items-center w-full text-black transition duration-75 p-2 rounded-lg pl-14">One Way</a>
                                    </li>
                                    <li>
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Laporan : Biaya Transportasi : One Way (1 Provinsi)</h1>
                    </div>
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="flex items-center justify-between p-4 md:py-2 md:px-4 rounded-t-xl bg-gradient-to-r from-sky-900 to-sky-700">
                                                <h3 class="text-md font-normal text-white">
                                                    Biaya Transportasi : One Way (1 Provinsi)
                                                </h3>
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="#">
                                                    ...
                                                    <div class="mt-3 mb-6 flex">
                                                        ...
                                                        <div class="md:w-2/6 ml-3">
                                                            <label for="text" class="block text-sm font-medium text-[#102E48] mt-2">Tujuan Kota/Kab </label>
                                                        </div>
