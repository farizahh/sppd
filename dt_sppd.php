        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 mt-14">
                ...
                <form action="" method="post">
                    ...
                    <div class="mt-3 mb-6 flex">
                        <div class="md:w-1/6">
                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Maksud Perjalanan Dinas</label>
                        </div>
                        <div class="md:w-5/6">
                    ...
                    <div class="mt-3 mb-6 flex">
                        <div class="md:w-2/6">
                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Tempat Berangkat</label>
                        </div>
                        <div class="md:w-4/6">
                            <input type="name" id="name" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" disabled />
                        </div>
                        <div class="md:w-2/6 pl-3">
                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Tujuan Berangkat</label>
                        </div>
                        <div class="md:w-4/6">
                            <input type="name" id="name" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" disabled />
                        </div>
                    ...
                    <div class="mt-3 mb-6 flex">
                        <div class="md:w-2/6">
                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Lama Perjalanan Dinas</label>
                        </div>
                        <div class="md:w-4/6">
                            <input type="name" id="name" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" disabled />
                        </div>
                        <div class="md:w-2/6 pl-3">
                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Alat Kendaraan</label>
                        </div>
                        <div class="md:w-4/6">
                            <input type="name" id="name" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" disabled />
                        </div>
                    ...
                    <div class="mt-3 mb-6 flex">
                        <div class="md:w-1/6">
                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Nama Pengikut</label>
                        </div>
                        <div class="md:w-5/6">
                            <textarea id="message" rows="4" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" disabled></textarea>
                        </div>
                    ...
                    <div class="flex float-right mb-12">
                        <button type="button" onclick="window.location.href = 'sppd.php';" class="text-white bg-red-600 hover:bg-red-700 font-medium rounded-lg text-xs px-5 py-2.5 me-2 mb-2">Batal</button>
