                        ...
                        <ul id="dropdown-lp" class="py-2 space-y-2 text-sm">
                            <li>
                                <button type="button" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-[#D6F170] hover:text-black group" aria-controls="dropdown-uha" data-collapse-toggle="dropdown-uha">
                                    ...
                                    <span class="text-gray-600 group-hover:text-black text-sm ms-3 whitespace-nowrap pr-20">Uang Harian</span>
                            ...
                            <li>
                                <button type="button" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-[#D6F170] hover:text-black group" aria-controls="dropdown-tr" data-collapse-toggle="dropdown-tr">
                                    <i class="fa-solid fa-file-pen w-5 h-5 text-gray-600 transition duration-75 group-hover:text-black"></i>
                                    <span class="text-gray-600 text-sm ms-3 whitespace-nowrap pr-9">Biaya Transportasi</span>
                            ...
                            <li>
                                <a href="by_penginapan.php" class="flex items-center p-2 text-black rounded-lg bg-[#D6F170] hover:text-black group active">
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Laporan : Biaya Penginapan</h1>
                    </div>
                                                ...
                                                <form class="space-y-4" action="#">
                                                    ...
                                                    <div class="mt-3 mb-6 flex">
                                                        ...
                                                        <div class="md:w-4/6 flex">
                                                            ...
                                                            <p class="pl-1 pt-2 text-sm font-medium text-[#102E48]">orang/hari</p>
                                                        </div>
                                                    </div>
                                                    <div class="mt-3 mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="text" class="block text-sm font-medium text-[#102E48] mt-2">Sebagai</label>
                                                        </div>
                                                        <div class="md:w-4/6">
                                                            <select id="prv" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300">
