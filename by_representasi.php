...
<head>
    ...
    <title>Biaya Representasi</title>
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li class="bg-[#D6F170] rounded-lg">
                        ...
                        <ul id="dropdown-lp" class="py-2 space-y-2 text-sm">
                            ...
                            <li>
                                <a href="by_representasi.php" class="flex items-center p-2 text-black rounded-lg bg-[#D6F170] hover:text-black group active">
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Laporan : Uang Representasi Perjalanan Dinas</h1>
                    </div>
