...
<body>
    <section id="sidebar">
                        ...
                        <ul id="dropdown-mt" class="py-2 space-y-2 text-sm">
                            ...
                            <li>
                                <button type="button" class="flex items-center p-2 pl-8 text-black rounded-lg group" aria-controls="dropdown-tr" data-collapse-toggle="dropdown-tr">
                                    ...
                                    <i class="fa-solid fa-angle-right w-3 h-3 hover:text-black transition duration-75 group-hover:text-black"></i>
                                </button>
                                <ul id="dropdown-tr" class="py-2 space-y-2 text-sm">
                                    <li>
                                        <a href="sewa_dd.php" class="flex items-center w-full text-gray-600 transition duration-75 p-2 rounded-lg pl-14 hover:text-black">Dalam Daerah</a>
                                    </li>
                                    <li>
                                        <a href="sewa_ldk.php" class="flex items-center w-full text-black transition duration-75 p-2 rounded-lg pl-14 hover:text-black">Luar Daerah (Dari Kedudukan ke Tempat Tujuan)</a>
                                    </li>
                                    <li>
        ...
        $query_total = "SELECT COUNT(*) as total FROM sewa_ldk";
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Transportasi : Sewa Kendaraan : Luar Daerah : Kedudukan Ke Tujuan</h1>
                    </div>
                    <div class="shadow-lg px-5 py-3">
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="flex items-center justify-between p-4 md:py-2 md:px-4 rounded-t-xl bg-gradient-to-r from-sky-900 to-sky-700">
                                                <h3 class="text-md font-normal text-white">
                                                    Tambah Data Transportasi : Sewa Kendaraan : Luar Daerah : Kedudukan Ke Tujuan
                                                </h3>
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dtsewaldk.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="jenis_kendaraan" class="block text-sm font-medium text-[#102E48]">Jenis Kendaraan</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="jenis_kendaraan" name="jenis_kendaraan" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan Jenis Kendaraan..." required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="satuan" class="block text-sm font-medium text-[#102E48]">Satuan</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="satuan" name="satuan" class="bg-gray-200 border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-900" placeholder="Unit/Hari" disabled />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="besaran" class="block text-sm font-medium text-[#102E48]">Besaran</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="besaran" name="besaran" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal biaya..." required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="minimal_personil" class="block text-sm font-medium text-[#102E48]">Minimal Personil</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="minimal_personil" name="minimal_personil" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan jumlah orang..." required />
                                                        </div>
                                                    </div>
                                            </div>
                                            <!-- Modal footer -->
                        ...
                        <div class="overflow-x-auto shadow-lg sm:rounded-lg mt-3">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM sewa_ldk LIMIT $halaman_awal, $batas";
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='px-6 py-3 text-center'>" . $row['jenis_kendaraan'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>Unit/Hari</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['besaran'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['minimal_personil'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>
                                                <a href='edit_dtsewaldk.php?edit=" . $row['jenis_kendaraan'] . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                    <i class='fa-solid fa-file-circle-check'></i>
                                                </a> 
                                                <a href='proses_delete_dtsewaldk.php?delete=" . $row['jenis_kendaraan'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
                                            ...
                                            echo "<tr><td colspan='6' class='text-center p-2'>Tidak ada data</td></tr>";
                                        }
                                    } else {
