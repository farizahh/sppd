...
<body>
    <section id="sidebar">
                ...
                <ul class="space-y-2 font-medium">
                        ...
                        <ul id="dropdown-mb" class="py-2 space-y-2 text-sm">
                            <li>
                                ...
                                <ul id="dropdown-uha" class="py-2 space-y-2 text-sm">
                                    <li>
                                        <a href="data_uhpddn.php" class="flex items-center w-full p-2 text-black transition duration-75 rounded-lg pl-20 group hover:text-black">PDDN</a>
                                    </li>
                                    <li>
                                        <a href="data_uhrapat.php" class="flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-20 group hover:text-black">Kegiatan Rapat</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <li>
                        <button type="button" class="flex items-center p-2 pr-4 rounded-lg hover:bg-[#D6F170] text-gray-500 hover:text-black group" aria-controls="dropdown-md" data-collapse-toggle="dropdown-md">
                            <i class="fa-solid fa-file-circle-plus w-5 h-5 text-gray-500 transition duration-75 group-hover:text-black"></i>
                            <span class="text-sm ms-3 whitespace-nowrap pr-7">D. Master Daerah</span>
                            <svg class="w-3 h-3 text-gray-500 group-hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        </button>
        ...
        $query_total = "SELECT COUNT(*) as total FROM uh_pddn";
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Biaya : Uang Harian : Perjalanan Dinas Dalam Negeri</h1>
                    </div>
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="flex items-center justify-between p-4 md:py-2 md:px-4 rounded-t-xl bg-gradient-to-r from-sky-900 to-sky-700">
                                                <h3 class="text-md font-normal text-white">
                                                    Tambah Data Biaya : Uang Harian : Perjalanan Dinas Dalam Negeri
                                                </h3>
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dtuhpddn.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                    ...
                                                    <div class="mb-6 flex">
                                                        ...
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="luar_kota" name="luar_kota" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                        ...
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="dalam_kota" name="dalam_kota" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="diklat" class="block text-sm font-medium text-[#102E48] mt-2">Diklat</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="diklat" name="diklat" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                                                        </div>
                                                    </div>
                                            </div>
                                            <!-- Modal footer -->
                        ...
                        <div class="overflow-x-auto shadow-lg sm:rounded-lg mt-3">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT uh_pddn.kode_provinsi, provinsi.nama_provinsi, uh_pddn.luar_kota, uh_pddn.dalam_kota, uh_pddn.diklat
                                            FROM uh_pddn
                                            JOIN provinsi ON uh_pddn.kode_provinsi = provinsi.kode_provinsi
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='px-6 py-3 text-center'>OH</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['luar_kota'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['dalam_kota'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['diklat'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>
                                                <a href='edit_dtuhpddn.php?edit=" . $row['kode_provinsi'] . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                    <i class='fa-solid fa-file-circle-check'></i>
                                                </a> 
                                                
                                                <a href='proses_delete_dtuhpddn.php?delete=" . $row['kode_provinsi'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
