...
<body>
    <section id="sidebar">
        ...
        $query_total = "SELECT COUNT(*) as total FROM jabatan";
        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 mt-14">
                <h1 class="text-[#23212F] font-medium text-2xl">Data Jabatan</h1>
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Jabatan</h1>
                    </div>
                                    ...
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dtjbt.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Kode Jabatan </label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="name" id="kode_jabatan" name="kode_jabatan" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                        ...
                                                        <div class="md:w-5/6">
                                                            <input type="name" id="jenis_jabatan" name="jenis_jabatan" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                                                        </div>
                                                    </div>
                                            </div>
                                            <!-- Modal footer -->
                        ...
                        <div class="overflow-x-auto shadow-lg sm:rounded-lg mt-3">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM jabatan LIMIT $halaman_awal, $batas";
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='px-6 py-3 text-center'>" . $row['kode_jabatan'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['jenis_jabatan'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>
                                                    <a href='edit_dtjbt.php?edit=" . $row['kode_jabatan'] . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                        <i class='fa-solid fa-file-circle-check'></i>
                                                    </a> 
                                                    
                                                    <a href='proses_delete_dtjbt.php?delete=" . $row['kode_jabatan'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
