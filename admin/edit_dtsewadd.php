...
if (isset($_GET['jenis_kendaraan'])) {
    ...
    $query = "SELECT * FROM sewa_dd WHERE jenis_kendaraan = ?";
...
$sewa_dd_query = "SELECT * FROM sewa_dd";
$sewa_dd_result = $koneksi->query($sewa_dd_query);
...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE sewa_dd SET besaran = ?, minimal_personil = ? WHERE jenis_kendaraan = ?";
...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-14">
            <h1 class="text-[#23212F] font-medium text-2xl">Edit Data Transportasi Sewa DD</h1>
            <div class="border-solid">
                <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                    <h1 class="text-white text-md font-semibold">Edit Data Transportasi Sewa DD</h1>
                </div>
                <div class="shadow-lg px-5 py-3">
                    <form action="" method="POST">
                        <div class="mb-6 flex">
                            ...
                            <div class="md:w-5/6">
                                <select id="jenis_kendaraan" name="jenis_kendaraan" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2" required>
                                    ...
                                    while ($sewa_dd_row = $sewa_dd_result->fetch_assoc()) :
                                        $jenis_kendaraan_option = $sewa_dd_row['jenis_kendaraan'];
                                    ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <a href="sewa_dd.php" class="text-blue-500 hover:text-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Back</a>
                        </div>
                    </form>
                </div>
            </div>
