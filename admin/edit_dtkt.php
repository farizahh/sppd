...
if(isset($_GET['edit'])) {
    ...
    $query = "SELECT * FROM kota WHERE kode_kota = '$kode_kota'; ";
...
if(isset($_POST['submit'])) {
    ...
    $nama_kota_new = $_POST['nama_kota'];

    // Update the data in the database
    $query = "UPDATE kota SET kode_kota = '$kode_kota_new', nama_kota = '$nama_kota_new' WHERE kode_kota = $kode_kota";
                ...
                <h1 class="bg-gradient-to-r from-sky-900 to-sky-700 text-white font-medium text-md px-5 py-3 rounded-xl">Data Pangkat/Golongan</h1>
                    <form action="" method="post">
                        <div class="mt-5 mb-6 flex">
                            ...
                            <div class="md:w-5/6">
                                <input type="text" id="kode_kota" name="kode_kota" value="<?php echo $kode_kota; ?>" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                            </div>
                        </div>
                        <div class="mt-3 mb-6 flex">
                            ...
                            <div class="md:w-5/6">
                                <input type="text" id="nama_kota" name="nama_kota" value="<?php echo $nama_kota; ?>" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                            </div>
                        </div>
                        <div class="flex float-right mb-10">
                            <button type="button" onclick="window.location.href = 'data_kota.php';" class="text-white bg-slate-500 hover:bg-slate-600 font-medium rounded-lg text-xs px-5 py-2 me-2 mb-2">Kembali</button>
