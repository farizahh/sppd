...
<body>
    <section id="sidebar">
            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-[#102E48]">
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li class="bg-[#D6F170] rounded-lg">
                        <button type="button" class="flex items-center p-2 pr-8 text-black hover:text-black group active" aria-controls="dropdown-mb" data-collapse-toggle="dropdown-mb">
                            <i class="fa-solid fa-file-circle-plus w-5 h-5 text-black transition duration-75 group-hover:text-black"></i>
                            <span class="flex-1 ms-3 whitespace-nowrap pr-10 text-sm">D. Master Biaya</span>
                            <i class="fa-solid fa-angle-down w-3 h-3 black group-hover:text-black"></i>
                        </button>
                        <ul id="dropdown-mb" class="py-2 space-y-2 text-sm">
                            <li>
                                <button type="button" class="flex items-center p-2 text-black hover:text-black group" aria-controls="dropdown-uha" data-collapse-toggle="dropdown-uha">
                                    <span class="flex-1 ms-3 whitespace-nowrap pr-14 text-sm px-6">Uang Harian</span>
                                    <i class="fa-solid fa-angle-right w-3 h-3 text-black group-hover:text-black"></i>
                                </button>
                                <ul id="dropdown-uha" class="py-2 space-y-2 text-sm">
                                    <li>
                                        <a href="data_uhpddn.php" class="flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-20 group hover:text-black">PDDN</a>
                                    </li>
                                    <li>
                                        <a href="data_uhrapat.php" class="flex items-center w-full p-2 text-black transition duration-75 rounded-lg pl-20 group hover:text-black">Kegiatan Rapat</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="data_penginapan.php" class="flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-11 group hover:text-black">Biaya Penginapan</a>
                            </li>
                            <li>
                                <a href="data_ur.php" class="flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-11 group hover:text-black">Uang Representasi</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <button type="button" class="flex items-center p-2 pr-4 rounded-lg hover:bg-[#D6F170] text-gray-500 hover:text-black group" aria-controls="dropdown-mt" data-collapse-toggle="dropdown-mt">
                            <i class="fa-solid fa-file-circle-plus w-5 h-5 text-gray-500 transition duration-75 group-hover:text-black"></i>
                            <span class="text-sm ms-3 whitespace-nowrap pr-3">D. Master Transport</span>
                    ...
                    <li>
                        <button type="button" class="flex items-center p-2 pr-4 rounded-lg hover:bg-[#D6F170] text-gray-500 hover:text-black group" aria-controls="dropdown-md" data-collapse-toggle="dropdown-md">
                            <i class="fa-solid fa-file-circle-plus w-5 h-5 text-gray-500 transition duration-75 group-hover:text-black"></i>
                            <span class="text-sm ms-3 whitespace-nowrap pr-5">D. Master Daerah</span>
                            <svg class="w-3 h-3 text-gray-500 group-hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        </button>
        ...
        $query_total = "SELECT COUNT(*) as total FROM uh_rapat";
        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 mt-14">
                <h1 class="text-[#23212F] font-medium text-2xl">Data Biaya</h1>
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Biaya : Uang Harian : Kegiatan Rapat</h1>
                    </div>
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="flex items-center justify-between p-4 md:py-2 md:px-4 rounded-t-xl bg-gradient-to-r from-sky-900 to-sky-700">
                                                <h3 class="text-md font-normal text-white">
                                                    Tambah Data Biaya : Uang Harian : Kegiatan Rapat
                                                </h3>
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dtuhrapat.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-5/6">
                                                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Provinsi</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <select id="kode_provinsi" name="kode_provinsi" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" required>
                                                    ...
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="fullboard_lk" class="block text-sm font-medium text-[#102E48] mt-2">Fullboard Luar Kota </label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="fullboard_lk" name="fullboard_lk" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal uang harian..." required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="fullboard_dk" class="block text-sm font-medium text-[#102E48] mt-2">Fullboard Dalam Kota</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="fullboard_dk" name="fullboard_dk" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal uang harian..." required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="fullhalfday_dk" class="block text-sm font-medium text-[#102E48] mt-2">Fullday/Halfday Dalam Kota </label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="fullhalfday_dk" name="fullhalfday_dk" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal uang harian..." required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="residence_dk" class="block text-sm font-medium text-[#102E48] mt-2">Residence Dalam Kota </label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="residence_dk" name="residence_dk" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal uang harian..." required />
                                                        </div>
                                                    </div>
                                            </div>
                                            <!-- Modal footer -->
                            ...
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                <thead class="text-xs text-gray-700 uppercase bg-gray-50 text-center">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-1 py-3">
                                            Fullboard/Halfday Dalam Kota
                                        </th>
                                        <th scope="col" class="px-1 py-3">
                                            Residence Dalam Kota
                                        </th>
                                        <th scope="col" class="px-1 py-3">
                                            Aksi
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT uh_rapat.kode_provinsi, provinsi.nama_provinsi, uh_rapat.fullboard_lk, uh_rapat.fullboard_dk, uh_rapat.fullhalfday_dk, uh_rapat.residence_dk
                                        FROM uh_rapat
                                        JOIN provinsi ON uh_rapat.kode_provinsi = provinsi.kode_provinsi
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='px-1 py-3 text-center'>" . $nomor++ . "</td>";
                                                echo "<td class='px-1 py-3 text-center'>" . $row['nama_provinsi'] . "</td>";
                                                echo "<td class='px-1 py-3 text-center'>OH</td>";
                                                echo "<td class='px-1 py-3 text-center'>" . $row['fullboard_lk'] . "</td>";
                                                echo "<td class='px-1 py-3 text-center'>" . $row['fullboard_dk'] . "</td>";
                                                echo "<td class='px-1 py-3 text-center'>" . $row['fullhalfday_dk'] . "</td>";
                                                echo "<td class='px-1 py-3 text-center'>" . $row['residence_dk'] . "</td>";
                                                echo "<td class='px-1 py-3 text-center'>
                                                <a href='edit_dtuhrapat.php?edit=" . $row['kode_provinsi'] . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                    <i class='fa-solid fa-file-circle-check'></i>
                                                </a> 
                                                
                                                <a href='proses_delete_dtuhrapat.php?delete=" . $row['kode_provinsi'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
                                            ...
                                            echo "<tr><td colspan='7' class='text-center p-2'>Tidak ada data</td></tr>";
                                        }
                                    } else {
                                        echo "<tr><td colspan='7' class='text-center'>Error: " . $koneksi->error . "</td></tr>";
                                    }
