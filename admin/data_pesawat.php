...
<body>
    <section id="sidebar">
        ...
        $query_total = "SELECT COUNT(*) as total FROM pesawat";
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Transportasi : Pesawat</h1>
                    </div>
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="flex items-center justify-between p-4 md:py-2 md:px-4 rounded-t-xl bg-gradient-to-r from-sky-900 to-sky-700">
                                                <h3 class="text-md font-normal text-white">
                                                    Tambah Data Transportasi : Pesawat
                                                </h3>
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dtpsw.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="asal_kota" class="block text-sm font-medium text-[#102E48]">Asal</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <select id="asal_kota" name="asal_kota" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300">
                                                                <option selected disabled>- Pilih Asal Kota -</option>
                                                                <?php
                                                    ...
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="tujuan_kota" class="block text-sm font-medium text-[#102E48]">Tujuan</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <select id="tujuan_kota" name="tujuan_kota" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300">
                                                                <option selected disabled>- Pilih Tujuan Kota -</option>
                                                                <?php
                                                                $query = "SELECT * FROM kota";
                                                                $result = $koneksi->query($query);
                                                                if ($result->num_rows > 0) {
                                                    ...
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="bisnis" class="block text-sm font-medium text-[#102E48]">Bisnis</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="bisnis" name="bisnis" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal uang harian..." required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="ekonomi" class="block text-sm font-medium text-[#102E48]">Ekonomi</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="ekonomi" name="ekonomi" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal uang harian..." required />
                                                        </div>
                                                    </div>
                                            </div>
                                            <!-- Modal footer -->
                        ...
                        <div class="overflow-x-auto shadow-lg sm:rounded-lg mt-3">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT pesawat.kode_pesawat, kota_asal.nama_kota AS asal_kota, kota_tujuan.nama_kota AS tujuan_kota, pesawat.bisnis, pesawat.ekonomi
                                            FROM pesawat
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='px-6 py-3 text-center'>" . $row['asal_kota'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['tujuan_kota'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['bisnis'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['ekonomi'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>
                                                        <a href='edit_dtpsw.php?asal_kota=" . urlencode($row['asal_kota']) . "&tujuan_kota=" . urlencode($row['tujuan_kota']) . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                            <i class='fa-solid fa-file-circle-check'></i>
                                                        </a> 
                                                        <a href='proses_delete_dtpsw.php?delete=" . $row['kode_pesawat'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
