...
<body>
    <section id="sidebar">
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li class="bg-[#D6F170] rounded-lg">
                        ...
                        <ul id="dropdown-mt" class="py-2 space-y-2 text-sm">
                            ...
                            <li>
                                <a href="data_oneway.php" class="flex items-center w-full p-2 text-black transition duration-75 rounded-lg pl-11 group hover:bg-[#D6F170] hover:text-black">One Way</a>
                            </li>
                            <li>
        ...
        $query_total = "SELECT COUNT(*) as total FROM oneway";
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Transportasi : One Way</h1>
                    </div>
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="flex items-center justify-between p-4 md:py-2 md:px-4 rounded-t-xl bg-gradient-to-r from-sky-900 to-sky-700">
                                                <h3 class="text-md font-normal text-white">
                                                    Tambah Data Transportasi : One Way (1 Provinsi)
                                                </h3>
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dtow.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="name" class="block text-sm font-medium text-[#102E48]">Ibu Kota Provinsi</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <select id="kode_provinsi" name="kode_provinsi" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300">
                                                    ...
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="name" class="block text-sm font-medium text-[#102E48]">Kab/Kota Tujuan</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <select id="kode_kota" name="kode_kota" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300">
                                                                <option selected disabled>- Pilih Kab/Kota Tujuan -</option>
                                                                <?php
                                                    ...
                                                    <div class="mb-6 flex">
                                                        ...
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="satuan" name="satuan" class="bg-gray-200 border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-900" placeholder="Orang/Kali" disabled />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                        ...
                        <div class="overflow-x-auto shadow-lg sm:rounded-lg mt-3">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT oneway.kode_provinsi, provinsi.ibukota_provinsi, kota.nama_kota, oneway.besaran
                                            FROM oneway
                                            JOIN provinsi ON oneway.kode_provinsi = provinsi.kode_provinsi
                                            JOIN kota ON oneway.kode_kota = kota.kode_kota
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='px-6 py-3 text-center'>" . $row['nama_kota'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>Orang/Kali</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['besaran'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>
                                                <a href='edit_dtow.php?edit=" . $row['kode_provinsi'] . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                    <i class='fa-solid fa-file-circle-check'></i>
                                                </a> 
                                                <a href='proses_delete_dtow.php?delete=" . $row['kode_provinsi'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
