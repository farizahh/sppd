...
if(isset($_POST['submit'])) {
    ...
    $jenis_golongan_new = $_POST['jenis_golongan'];

    // Update the data in the database
    $query = "UPDATE golongan SET kode_golongan = '$kode_golongan_new', jenis_golongan = '$jenis_golongan_new' WHERE kode_golongan = $kode_golongan";
    ...
    <section id="sidebar">
        ...
        <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            ...
            <div class="p-4 sm:ml-64">
                <div class="p-4 mt-14">
                <h1 class="bg-gradient-to-r from-sky-900 to-sky-700 text-white font-medium text-md px-5 py-3 rounded-xl">Data Pangkat/Golongan</h1>
                    <form action="" method="post">
                        <div class="mt-5 mb-6 flex">
                            <div class="md:w-1/6">
                                <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Kode Pangkat/Golongan </label>
                            </div>
                            <div class="md:w-5/6">
                                <input type="text" id="kode_golongan" name="kode_golongan" value="<?php echo $kode_golongan; ?>" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                            </div>
                        </div>
                        <div class="mt-3 mb-6 flex">
                            <div class="md:w-1/6">
                                <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Jenis Pangkat/Golongan </label>
                            </div>
                            <div class="md:w-5/6">
                                <input type="text" id="jenis_golongan" name="jenis_golongan" value="<?php echo $jenis_golongan; ?>" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                            </div>
                        </div>
                        <div class="flex float-right mb-10">
                            <button type="button" onclick="window.location.href = 'data_golongan.php';" class="text-white bg-slate-500 hover:bg-slate-600 font-medium rounded-lg text-xs px-5 py-2 me-2 mb-2">Kembali</button>
