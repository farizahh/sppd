...
<head>
    ...
    <title>Data Uang Representasi</title>
...
<body>
    <section id="sidebar">
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li class="bg-[#D6F170] rounded-lg">
                        ...
                        <ul id="dropdown-mb" class="py-2 space-y-2 text-sm">
                            ...
                            <li>
                                <a href="data_penginapan.php" class="flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-11 group hover:bg-[#D6F170] hover:text-black">Biaya Penginapan</a>
                            </li>
                            <li>
                                <a href="data_ur.php" class="flex items-center w-full p-2 text-black transition duration-75 rounded-lg pl-11 group">Uang Representasi</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <?php
        // Menentukan batas entri per halaman
        ...
        $query_total = "SELECT COUNT(*) as total FROM ur";
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Biaya : Uang Representasi</h1>
                    </div>
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="flex items-center justify-between p-4 md:py-2 md:px-4 rounded-t-xl bg-gradient-to-r from-sky-900 to-sky-700">
                                                <h3 class="text-md font-normal text-white">
                                                    Tambah Data Biaya : Uang Representasi
                                                </h3>
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dtur.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="kode_jabatan" class="block text-sm font-medium text-[#102E48]">Sebagai</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <select id="kode_jabatan" name="kode_jabatan" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300">
                                                    ...
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="luar_kota" class="block text-sm font-medium text-[#102E48]">Luar Kota</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="luar_kota" name="luar_kota" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal biaya penginapan" required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="dalam_kota" class="block text-sm font-medium text-[#102E48]">Dalam Kota (> 8 Jam)</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="dalam_kota" name="dalam_kota" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal biaya penginapan" required />
                                                        </div>
                                                    </div>
                                            </div>
                                            <!-- Modal footer -->
                        ...
                        <div class="overflow-x-auto shadow-lg sm:rounded-lg mt-3">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT ur.kode_jabatan, jabatan.jenis_jabatan, ur.luar_kota, ur.dalam_kota
                                            FROM ur
                                            JOIN jabatan ON ur.kode_jabatan = jabatan.kode_jabatan
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='px-6 py-3 text-center'>" . $row['jenis_jabatan'] . "</td>";
                                                ...
                                                echo "<td class='px-6 py-3 text-center'>
                                                        <a href='edit_dtur.php?edit=" . $row['kode_jabatan'] . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                            <i class='fa-solid fa-file-circle-check'></i>
                                                        </a> 
                                                        
                                                        <a href='proses_delete_dtur.php?delete=" . $row['kode_jabatan'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
