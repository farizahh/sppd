...
// Fetch provinsi data from database
...
if (isset($_GET['edit'])) {
    ...
    $query = "SELECT * FROM uh_pddn WHERE kode_provinsi = ?";
...
if (isset($_POST['submit'])) {
    ...
    $diklat_new = $_POST['diklat'];

    // Update the data in the database
    $query = "UPDATE uh_pddn SET luar_kota = ?, dalam_kota = ?, diklat = ? WHERE kode_provinsi = ?";
    $stmt = $koneksi->prepare($query);
    $stmt->bind_param("ssss", $luar_kota_new, $dalam_kota_new, $diklat_new, $kode_provinsi_new);
...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-14">
            <h1 class="text-[#23212F] font-medium text-2xl">Edit Data Uang Harian PDDN</h1>
            <div class="border-solid">
                <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                    <h1 class="text-white text-md font-semibold">Edit Data Uang Harian PDDN</h1>
                </div>
                <div class="shadow-lg px-5 py-3">
                    <form action="" method="POST">
                        ...
                        <div class="mb-6 flex">
                            ...
                            <div class="md:w-5/6">
                                <input type="text" id="diklat" name="diklat" value="<?php echo $diklat; ?>" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukkan halfday dalam kota..." required />
                            </div>
                        </div>
                        <div class="flex items-center">
                            ...
                            <a href="data_uhpddn.php" class="text-blue-500 hover:text-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Back</a>
                        </div>
                    </form>
                </div>
            </div>
