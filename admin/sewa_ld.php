...
<body>
    <section id="sidebar">
                        ...
                        <ul id="dropdown-mt" class="py-2 space-y-2 text-sm">
                            ...
                            <li>
                                ...
                                <ul id="dropdown-tr" class="py-2 space-y-2 text-sm">
                                    ...
                                    <li>
                                        <a href="sewa_ld.php" class="flex items-center w-full text-black transition duration-75 p-2 rounded-lg pl-14 hover:text-black">Luar Daerah (Dari Tempat Tujuan)</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
        ...
        $query_total = "SELECT COUNT(*) as total FROM sewa_ld";
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Transportasi : Sewa Kendaraan : Luar Daerah : Di Tempat Tujuan</h1>
                    </div>
                    <div class="shadow-lg px-5 py-3">
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="flex items-center justify-between p-4 md:py-2 md:px-4 rounded-t-xl bg-gradient-to-r from-sky-900 to-sky-700">
                                                <h3 class="text-md font-normal text-white">
                                                    Tambah Data Transportasi : Sewa Kendaraan : Luar Daerah : Di Tujuan
                                                </h3>
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dtsewald.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                        ...
                        <div class="overflow-x-auto shadow-lg sm:rounded-lg mt-3">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM sewa_ld LIMIT $halaman_awal, $batas";
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <a href='edit_dtsewald.php?edit=" . $row['jenis_kendaraan'] . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                    <i class='fa-solid fa-file-circle-check'></i>
                                                </a> 
                                                <a href='proses_delete_dtsewald.php?delete=" . $row['jenis_kendaraan'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
