...
<body>
    <section id="sidebar">
        ...
        <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-[#102E48]">
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="data_golongan.php" class="flex items-center p-2 text-vlack rounded-lg hover:bg-[#D6F170] hover:text-black group active">
                    ...
                    <li>
                        <button type="button" class="flex items-center p-2 pr-8 rounded-lg hover:bg-[#D6F170] text-gray-500 hover:text-black group" aria-controls="dropdown-mb" data-collapse-toggle="dropdown-mb">
                            <i class="fa-solid fa-file-circle-plus w-5 h-5 text-gray-500 transition duration-75 group-hover:text-black"></i>
                        ...
                        <ul id="dropdown-mb" class="hidden py-2 space-y-2 text-sm">
                            <li>
                                <button type="button" class="flex items-center p-2 rounded-lg hover:bg-[#D6F170] text-gray-500 hover:text-black group" aria-controls="dropdown-uha" data-collapse-toggle="dropdown-uha">
                                    <span class="flex-1 ms-3 whitespace-nowrap text-sm px-4">Uang Harian</span>
        ...
        $query_total = "SELECT COUNT(*) as total FROM golongan";
        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 mt-14">
                <h1 class="text-[#23212F] font-medium text-2xl">Data Golongan</h1>
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-md mt-4 p-4">
                        <h1 class="text-white text-lg font-semibold">Data Pangkat / Golongan</h1>
                    </div>
                                    ...
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dtglg.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Kode Jabatan </label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="name" id="kode_golongan" name="kode_golongan" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                        ...
                                                        <div class="md:w-5/6">
                                                            <input type="name" id="jenis_golongan" name="jenis_golongan" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2" required />
                                                        </div>
                                                    </div>
                                            </div>
                                            <!-- Modal footer -->
                        ...
                        <div class="overflow-x-auto shadow-lg sm:rounded-lg mt-3">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM golongan LIMIT $halaman_awal, $batas";
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='px-6 py-3 text-center'>" . $row['kode_golongan'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>" . $row['jenis_golongan'] . "</td>";
                                                echo "<td class='px-6 py-3 text-center'>
                                                    <a href='edit_dtglg.php?edit=" . $row['kode_golongan'] . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                        <i class='fa-solid fa-file-circle-check'></i>
                                                    </a> 
                                                    
                                                    <a href='proses_delete_dtglg.php?delete=" . $row['kode_golongan'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
