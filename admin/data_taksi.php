...
<body>
    <section id="sidebar">
        ...
        $query_total = "SELECT COUNT(*) as total FROM taksi";
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Transportasi : Taksi</h1>
                    </div>
                    <div class="shadow-lg px-5 py-3">
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="flex items-center justify-between p-4 md:py-2 md:px-4 rounded-t-xl bg-gradient-to-r from-sky-900 to-sky-700">
                                                <h3 class="text-md font-normal text-white">
                                                    Tambah Data Transportasi : Taksi
                                                </h3>
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dttx.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="name" class="block text-sm font-medium text-[#102E48]">Provinsi</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                    ...
                                                    <div class="mb-6 flex">
                                                        ...
                                                        <div class="md:w-5/6">
                                                            <input type="txt" id="besaran" name="besaran" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal biaya..." required />
                                                        </div>
                                                    </div>
                                            </div>
                                            <!-- Modal footer -->
                        ...
                        <div class="overflow-x-auto shadow-lg sm:rounded-lg mt-3">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT taksi.kode_provinsi, provinsi.nama_provinsi, taksi.besaran
                                        FROM taksi
                                        JOIN provinsi ON taksi.kode_provinsi = provinsi.kode_provinsi
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='px-3 py-3 text-center'>" . $row['nama_provinsi'] . "</td>";
                                                echo "<td class='px-3 py-3 text-center'>Orang/Kali</td>";
                                                echo "<td class='px-3 py-3 text-center'>" . $row['besaran'] . "</td>";
                                                echo "<td class='px-3 py-3 text-center'>
                                                <a href='edit_dttx.php?edit=" . $row['kode_provinsi'] . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                    <i class='fa-solid fa-file-circle-check'></i>
                                                </a> 
                                                <a href='proses_delete_dttx.php?delete=" . $row['kode_provinsi'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
                                            ...
                                            echo "<tr><td colspan='5' class='text-center p-2'>Tidak ada data</td></tr>";
                                        }
                                    } else {
                                        echo "<tr><td colspan='5' class='text-center'>Error: " . $koneksi->error . "</td></tr>";
                                    }
