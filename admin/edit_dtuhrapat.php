...
if (isset($_GET['edit'])) {
    ...
    $query = "SELECT * FROM uh_rapat WHERE kode_provinsi = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $fullboard_lk = $row['fullboard_lk'];
        $fullboard_dk = $row['fullboard_dk'];
        $fullhalfday_dk = $row['fullhalfday_dk'];
        $residence_dk = $row['residence_dk'];
    } else {
        echo "Data not found!";
        exit();
    }
...
if (isset($_POST['submit'])) {
    ...
    $fullboard_lk_new = $_POST['fullboard_lk'];
    $fullboard_dk_new = $_POST['fullboard_dk'];
    $fullhalfday_dk_new = $_POST['fullhalfday_dk'];
    $residence_dk_new = $_POST['residence_dk'];

    // Update the data in the database
    $query = "UPDATE uh_rapat SET fullboard_lk = ?, fullboard_dk = ?, fullhalfday_dk = ?, residence_dk = ? WHERE kode_provinsi = ?";
    $stmt = $koneksi->prepare($query);
    $stmt->bind_param("sssss", $fullboard_lk_new, $fullboard_dk_new, $fullhalfday_dk_new, $residence_dk_new, $kode_provinsi_new);
...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-14">
            <h1 class="text-[#23212F] font-medium text-2xl">Edit Data Uang Harian Kegiatan Rapat</h1>
            <div class="border-solid">
                <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                    <h1 class="text-white text-md font-semibold">Edit Data Uang Harian Kegiatan Rapat</h1>
                </div>
                <div class="shadow-lg px-5 py-3">
                    <form action="" method="POST">
                        ...
                        <div class="mb-6 flex">
                            <div class="md:w-2/6">
                                <label for="fullboard_lk" class="block text-sm font-medium text-[#102E48] mt-2">fullboard_lk</label>
                            </div>
                            <div class="md:w-5/6">
                                <input type="text" id="fullboard_lk" name="fullboard_lk" value="<?php echo $fullboard_lk; ?>" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukkan fullboard luar kota..." required />
                            </div>
                        </div>
                        <div class="mb-6 flex">
                            <div class="md:w-2/6">
                                <label for="fullboard_dk" class="block text-sm font-medium text-[#102E48] mt-2">fullboard_dk </label>
                            </div>
                            <div class="md:w-5/6">
                                <input type="text" id="fullboard_dk" name="fullboard_dk" value="<?php echo $fullboard_dk; ?>" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukkan fullboard dalam kota..." required />
                            </div>
                        </div>
                        <div class="mb-6 flex">
                            <div class="md:w-2/6">
                                <label for="fullhalfday_dk" class="block text-sm font-medium text-[#102E48] mt-2">fullhalfday_dk</label>
                            </div>
                            <div class="md:w-5/6">
                                <input type="text" id="fullhalfday_dk" name="fullhalfday_dk" value="<?php echo $fullhalfday_dk; ?>" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukkan halfday dalam kota..." required />
                            </div>
                        </div>
                        <div class="mb-6 flex">
                            <div class="md:w-2/6">
                                <label for="residence_dk" class="block text-sm font-medium text-[#102E48] mt-2">residence_dk</label>
                            </div>
                            <div class="md:w-5/6">
                                <input type="text" id="residence_dk" name="residence_dk" value="<?php echo $residence_dk; ?>" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukkan halfday dalam kota..." required />
                            </div>
                        </div>
                        <div class="flex items-center">
                            ...
                            <a href="data_uhrapat.php" class="text-blue-500 hover:text-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Back</a>
                        </div>
                    </form>
                </div>
            </div>
