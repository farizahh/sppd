...
<body>
    <section id="sidebar">
        ...
        <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-[#102E48]">
                ...
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="admin.php" class="flex items-center p-2 text-gray-500 rounded-lg hover:bg-[#D6F170] hover:text-black group">
                    ...
                    <li class="bg-[#D6F170] rounded-lg">
                        <button type="button" class="flex items-center p-2 rounded-lg bg-[#D6F170] text-black hover:text-black group active" aria-controls="dropdown-mb" data-collapse-toggle="dropdown-mb">
                            <i class="fa-solid fa-file-circle-plus w-5 h-5 text-black transition duration-75 group-hover:text-black"></i>
                            <span class="flex-1 ms-3 whitespace-nowrap pr-14 text-sm">D. Master Biaya</span>
                            <i class="fa-solid fa-angle-down w-3 h-3 black group-hover:text-black"></i>
                        </button>
                        <ul id="dropdown-mb" class="py-2 space-y-2 text-sm">
                            <li>
                                <button type="button" class="flex items-center p-2 pl-5 rounded-lg hover:bg-[#D6F170] text-gray-600 hover:text-black group" aria-controls="dropdown-uha" data-collapse-toggle="dropdown-uha">
                                    <span class="flex-1 ms-3 whitespace-nowrap pr-16 text-sm px-4">Uang Harian</span>
                                ...
                                <ul id="dropdown-uha" class="hidden py-2 space-y-2 text-sm">
                                    <li>
                                        <a href="data_uhpddn.php" class="flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-20 group hover:bg-[#D6F170]">PDDN</a>
                                    </li>
                                    <li>
                                        <a href="data_uhrapat.php" class="flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-20 group hover:bg-[#D6F170]">Kegiatan Rapat</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="data_penginapan.php" class="flex items-center w-full p-2 text-black transition duration-75 rounded-lg pl-11 group">Biaya Penginapan</a>
                            </li>
                            <li>
                                <a href="data_ur.php" class="flex items-center w-full p-2 text-gray-600 transition duration-75 rounded-lg pl-11 group hover:bg-[#D6F170] hover:text-black">Uang Representasi</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        $query_total = "SELECT COUNT(*) as total FROM penginapan";
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Biaya : Penginapan</h1>
                    </div>
                                    ...
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="proses_insert_dtpgp.php" method="POST">
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Provinsi</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <select id="kode_provinsi" name="kode_provinsi" class="bg-white border border-gray-400 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-900">
                                                    ...
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="p1" class="block text-sm font-medium text-[#102E48]">Kepala Daerah/ <br>Wakil Kepala Daerah / <br>Pimpinan DPRD/ <br>Eselon l</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="p1" name="p1" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 mt-4 placeholder-gray-300" placeholder="Masukan nominal uang harian..." required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="p2" class="block text-sm font-medium text-[#102E48]">Anggota DPRD/ <br>Pejabat Eselon ll</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="p2" name="p2" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal uang harian..." required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="p3" class="block text-sm font-medium text-[#102E48]">Pejabat Eselon lll/<br>Golongan lV</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="p3" name="p3" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal uang harian..." required />
                                                        </div>
                                                    </div>
                                                    <div class="mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="p4" class="block text-sm font-medium text-[#102E48]">Pejabat Eselon V/<br>Golongan lll, ll, dan l</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="text" id="p4" name="p4" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300" placeholder="Masukan nominal uang harian..." required />
                                                        </div>
                                                    </div>
                                            </div>
                                            <!-- Modal footer -->
                            ...
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                                <thead class="text-xs text-gray-700 uppercase bg-gray-50 text-center">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-2 py-3">
                                            Kepala Daerah/ <br>Wakil Kepala Daerah/ <br>Pimpinan DPRD/ <br>Pejabat Eselon l
                                        </th>
                                        <th scope="col" class="px-2 py-3">
                                            Anggota DPRD/ <br>Pejabat Eselon II
                                        </th>
                                        <th scope="col" class="px-2 py-3">
                                            Pejabat Eselon lll/<br>Golongan IV
                                        </th>
                                        <th scope="col" class="px-2 py-3">
                                            Pejabat Eselon V/<br>Golongan III, II, dan I
                                        </th>
                                        <th scope="col" class="px-2 py-3">
                                            Aksi
                                        </th>
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT penginapan.kode_provinsi, provinsi.nama_provinsi, penginapan.p1, penginapan.p2, penginapan.p3, penginapan.p4
                                FROM penginapan
                                JOIN provinsi ON penginapan.kode_provinsi = provinsi.kode_provinsi
                                    ...
                                    if ($result) {
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td class='px-2 py-3 text-center'>" . $nomor++ . "</td>";
                                                echo "<td class='px-2 py-3 text-center'>" . $row['nama_provinsi'] . "</td>";
                                                echo "<td class='px-2 py-3 text-center'>OH</td>";
                                                echo "<td class='px-2 py-3 text-center'>" . $row['p1'] . "</td>";
                                                echo "<td class='px-2 py-3 text-center'>" . $row['p2'] . "</td>";
                                                echo "<td class='px-2 py-3 text-center'>" . $row['p3'] . "</td>";
                                                echo "<td class='px-2 py-3 text-center'>" . $row['p4'] . "</td>";
                                                echo "<td class='px-2 py-3 text-center'>
                                                <a href='edit_dtpgp.php?edit=" . $row['kode_provinsi'] . "' class='font-medium bg-amber-400 hover:bg-amber-500 text-black p-2 rounded-md text-xs mr-2 text-center'>
                                                    <i class='fa-solid fa-file-circle-check'></i>
                                                </a> 
                                                
                                                <a href='proses_delete_dtpgp.php?delete=" . $row['kode_provinsi'] . "' onclick='return confirmDelete()' type='button' class='font-medium bg-[#ff0000] hover:bg-red-800 text-[#ffdead] p-2 rounded-md text-xs text-center'>
