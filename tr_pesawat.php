                        ...
                        <ul id="dropdown-lp" class="py-2 space-y-2 text-sm">
                            ...
                            <li>
                                ...
                                <ul id="dropdown-tr" class="py-2 space-y-2 text-sm">
                                    <li>
                                        <a href="tr_pesawat.php" class="flex items-center w-full text-black transition duration-75 p-2 rounded-lg pl-14 ">Pesawat</a>
                                    </li>
                                    <li>
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Laporan : Biaya Transportasi : Pesawat</h1>
                    </div>
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="#">
                                                    ...
                                                    <div class="mt-3 mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="text" class="block text-sm font-medium text-[#102E48] mt-2">Asal Kota</label>
                                                        </div>
                                                        <div class="md:w-4/6">
                                                            <select id="kota" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300">
                                                        ...
                                                        <div class="md:w-2/6 ml-3">
                                                            <label for="text" class="block text-sm font-medium text-[#102E48] mt-2">Tujuan Kota </label>
                                                        </div>
                                                        <div class="md:w-4/6">
                                                            <select id="kota" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300">
                                                                <option selected>- Pilih Jenis Jabatan -</option>
