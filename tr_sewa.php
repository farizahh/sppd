                        ...
                        <ul id="dropdown-lp" class="py-2 space-y-2 text-sm">
                            ...
                            <li>
                                ...
                                <ul id="dropdown-tr" class="py-2 space-y-2 text-sm">
                                    ...
                                    <li>
                                        <a href="tr_sewa.php" class="flex items-center w-full text-black transition duration-75 p-2 rounded-lg pl-14">Sewa Kendaraan</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Laporan : Biaya Transportasi : Sewa Kendaraan</h1>
                    </div>
                                                ...
                                                <form class="space-y-4" action="#">
                                                    ...
                                                    <div class="mt-3 mb-6 flex">
                                                        ...
                                                        <div class="md:w-4/6 flex">
                                                            ...
                                                            <p class="pl-1 pt-2 text-sm font-medium text-[#102E48]">unit/hari</p>
                                                        </div>
