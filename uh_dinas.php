...
<head>
    ...
    <title>UH - Perjalanan Dinas</title>
                        ...
                        <ul id="dropdown-lp" class="py-2 space-y-2 text-sm">
                            <li>
                                ...
                                <ul id="dropdown-uha" class="py-2 space-y-2 text-sm">
                                    ...
                                    <li>
                                        <a href="uh_dinas.php" class="flex items-center w-full text-black transition duration-75 p-2 rounded-lg pl-14">Perjalanan Dinas</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Laporan : Uang Harian : Perjalanan Dinas</h1>
                    </div>
