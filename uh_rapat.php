                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li class="bg-[#D6F170] rounded-lg">
                        ...
                        <ul id="dropdown-lp" class="py-2 space-y-2 text-sm">
                            <li>
                                <button type="button" class="flex items-center p-2 text-[#D6F170] rounded-lg hover:bg-[#D6F170] hover:text-black group" aria-controls="dropdown-uha" data-collapse-toggle="dropdown-uha">
                                    <i class="fa-solid fa-file-pen w-5 h-5 text-black transition duration-75 group-hover:text-black"></i>
                                    <span class="text-black text-sm ms-3 whitespace-nowrap pr-16">Uang Harian</span>
                                    <i class="fa-solid fa-angle-right w-3 h-3 text-black transition duration-75 group-hover:text-black"></i>
                                </button>
                                <ul id="dropdown-uha" class="py-2 space-y-2 text-sm">
                                    <li>
                                        <a href="uh_rapat.php" class="flex items-center w-full text-black transition duration-75 p-2 rounded-lg pl-14">Kegiatan Rapat</a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                <button type="button" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-[#D6F170] hover:text-black group" aria-controls="dropdown-tr" data-collapse-toggle="dropdown-tr">
                                    ...
                                    <span class="text-gray-600 group-hover:text-black text-sm ms-3 whitespace-nowrap pr-5">Biaya Transportasi</span>
                            ...
                            <li>
                                <a href="cetak.php" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-[#D6F170] hover:text-black group">
                                    <i class="fa-solid fa-print w-5 h-5 text-gray-600 transition duration-75 group-hover:text-black"></i>
            ...
            <div class="p-4 mt-14">
                ...
                <div class="border-solid">
                    <div class="bg-[#193D5E] rounded-t-xl mt-4 p-4">
                        <h1 class="text-white text-md font-semibold">Data Laporan : Uang Harian : Kegiatan Rapat</h1>
                    </div>
                                        ...
                                        <div class="relative bg-[#F3F3F3] rounded-2xl shadow">
                                            ...
                                            <div class="flex items-center justify-between p-4 md:py-2 md:px-4 rounded-t-xl bg-gradient-to-r from-sky-900 to-sky-700">
                                                <h3 class="text-md font-normal text-white">
                                                    Uang Harian : Kegiatan Rapat atau di Luar Kantor - JATIM
                                                </h3>
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <form class="space-y-4" action="#">
                                                    ...
                                                    <div class="mt-3 mb-6 flex">
                                                        <div class="md:w-2/6">
                                                            <label for="text" class="block text-sm font-medium text-[#102E48] mt-2">Kategori</label>
                                                        </div>
                                                        <div class="md:w-4/6">
                                                            <select id="ktgr" class="bg-white border border-gray-400 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2 placeholder-gray-300">
                                                        ...
                                                        <div class="md:w-2/6 ml-3">
                                                            <label for="text" class="block text-sm font-medium text-[#102E48] mt-2">Durasi </label>
                                                        </div>
                                                        <div class="md:w-4/6 flex">
                                                            ...
                                                            <p class="pl-1 pt-2 text-sm font-medium text-[#102E48]">hari</p>
                                                        </div>
                                                    </div>
                                                    <div class="mt-3 mb-6 flex">
                                                        <div class="md:w-1/6">
                                                            <label for="number" class="block text-sm font-medium text-[#102E48] mt-2">Uang Harian</label>
                                                        </div>
                                                        <div class="md:w-5/6">
                                                            <input type="number" id="number" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" disabled />
                                                        </div>
