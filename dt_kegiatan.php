            ...
            <div class="p-4 mt-14">
                ...
                <form action="" method="post">
                    ...
                    <div class="mt-3 mb-6 flex">
                        <div class="md:w-1/6">
                            <label for="name" class="block text-sm font-medium text-[#102E48] mt-2">Kota/Kabupaten</label>
                        </div>
                        <div class="md:w-5/6">
                    ...
                    <div class="mt-3 mb-6 flex">
                        ...
                        <div class="md:w-4/6">
                            <input type="date" id="date" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2" />
                        </div>
                    ...
                    <div class="flex float-right">
                        <button type="button" onclick="window.location.href = '#';" class="text-white bg-slate-500 hover:bg-slate-600 font-medium rounded-lg text-xs px-5 py-2.5 me-2 mb-2">Kembali</button>
                    ...
                    <div class="mb-10">
                        <button type="button" onclick="window.location.href = 's_cetak.php';" class="text-white bg-emerald-600 hover:bg-emerald-700 font-medium rounded-lg text-sm w-full px-20 py-2.5 me-2 mb-2">Tahap Selanjutnya</button>
                    </div>
                </form>
            </div>
        </div>
